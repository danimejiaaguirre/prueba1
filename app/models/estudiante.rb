class Estudiante < ActiveRecord::Base
	...
	def self.search(search) 	
		where("nombre like '%#{search}%' or email like '%#{search}%' or cedula like '%#{search}%' or direccion like '%#{search}%'")  
	end
    ...
    attr_accessible :foto, :cedula, :curso_id, :direccion, :email, :fch_nacimiento, :nombre
